...
total_requests = db.get_first_value('SELECT COUNT(*) FROM request_logs_post').to_f
successful_requests = db.get_first_value('SELECT COUNT(*) FROM request_logs_post WHERE response_status = 200').to_f
